 ...
 */
package di.uniba.map.b.silenthouse.main.gameInterface;

import di.uniba.map.b.silenthouse.main.gameCore.Game.ChoiceHandler;
...
public class UI {
   private JPanel titleNamePanel, startButtonPanel, mainTextPanel, choiceButtonPanel, playerPanel, inventoryPanel, savePanel, ynPanel;
    ...
    public void createUI(ChoiceHandler cHandler){//}, InventoryHandler invHandler){
        ...
        titleNamePanel.setBounds(100,120,600,300);
        titleNamePanel.setBackground(Color.black);
        JLabel titleNameLabel = new JLabel("Silent House");
        ...
        //Pannello per Salva, Zaino ed Esci
        ...
        //Messaggio salvataggio avvenuto
