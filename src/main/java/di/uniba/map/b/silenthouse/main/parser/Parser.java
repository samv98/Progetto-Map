...
public class Parser {
    ...
    /**
     * Confronta il token con la lista dei comandi per contestualizzarlo.
     * Ritorna la posizione del comando trovato nella lista
     *
    ...
    /**
     * Confronta il token con la lista degli oggetti di una specifica stanza per
     * contestualizzarlo. Ritorna la posizione dell'oggetto trovato nella lista
     *
     * @param token parola da analizzare
    ...
    /**
     * Identifica la direzione indicata nel token. Restituisce una stringa con
     * una lettera rappresentativa
     *
     * @param token parola da analizzare
    ...
    /**
     * Classe principale del parser. Esegue le istruzioni di controllo di tutte
     * le parole ottenute in ingresso
     *
     ...
     * @return ParserOutput oggetto contenete gli eventuali comandi, oggetti con
     * cui interagire e direzioni
     */
